...
const standard = standards.find((s) => s.slug === 'astm-f1140')!;

export const metadata: Metadata = {
  title: standard.metaTitle,
  description: standard.metaDescription,
  alternates: { canonical: 'https://boulderpackagetesting.com/tests/astm-f1140' },
  openGraph: { title: standard.metaTitle, description: standard.metaDescription, url: 'https://boulderpackagetesting.com/tests/astm-f1140', type: 'website', images: [{ url: '/og-image.png', width: 1200, height: 630 }] },
};
