...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://boulderpackagetest.com/tests/astm-f1140' },
  openGraph: { title: standard.metaTitle, description: standard.metaDescription, url: 'https://boulderpackagetest.com/tests/astm-f1140', type: 'website', images: [{ url: '/og-image.png', width: 1200, height: 630 }] },
};
