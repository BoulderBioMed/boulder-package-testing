  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4">
        <Image src="/img/industry-dental.png" alt="Dental implants and surgical instruments" width={1600} height={900} sizes="(max-width: 1280px) 100vw, 1280px" priority className="w-full rounded-lg shadow-lg h-auto" style={{ objectFit: 'cover' }} />
      </div>
