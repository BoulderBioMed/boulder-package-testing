  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4">
        <img src="/img/industry-ivd-diagnostics.png" alt="IVD diagnostic devices and sample collection kits" className="w-full rounded-lg shadow-lg" style={{ aspectRatio: '16/9', objectFit: 'cover' }} />
      </div>
