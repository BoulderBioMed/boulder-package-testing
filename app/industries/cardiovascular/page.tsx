  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4">
        <img src="/img/industry-cardiovascular.png" alt="Cardiovascular medical devices - stents and catheters" className="w-full rounded-lg shadow-lg" style={{ aspectRatio: '16/9', objectFit: 'cover' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl space-y-10">
          ...
          <section className="bg-gray-light rounded-lg p-6">
            ...
            <p className="text-navy/60 italic">Anonymized case study placeholder — contact us to discuss specific cardiovascular device packaging validation projects.</p>
          </section>
