...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://boulderpackagetesting.com/about' },
  openGraph: { title: 'About Boulder Package Testing', description: 'Contract medical device package validation lab in Boulder, CO.', url: 'https://boulderpackagetesting.com/about', type: 'website', images: [{ url: '/og-image.png', width: 1200, height: 630 }] },
};
        ...
        <div className="max-w-3xl space-y-10">
          ...
          <section>
            ...
            <div className="bg-gray-light rounded-lg p-6">
              ...
              <p className="text-navy/80 leading-relaxed mb-4">
                Jim Kasic is the founder of the Boulder BioMed family of companies and an AAMI Certified Industrial Sterilization Specialist. With decades of experience in medical device manufacturing, sterilization, and quality systems, Jim established Boulder Package Testing to fill a critical gap in the Mountain West medtech corridor — a region that has historically lacked a dedicated medical device package testing laboratory.
              </p>
              <p className="text-navy/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-navy/70 text-sm">
                  ...
                  Email: <a href="mailto:info@boulderpackagetesting.com" className="text-teal hover:underline">info@boulderpackagetesting.com</a>
                </p>
              </div>
            </div>
          </section>
